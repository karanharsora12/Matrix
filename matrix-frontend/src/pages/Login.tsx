...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full flex">
      ...
      {/* ========== RIGHT LOGIN PANEL ========== */}
      <div className="flex-1 flex flex-col min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-zinc-900 dark:via-zinc-900 dark:to-zinc-900 relative overflow-hidden">
        ...
        <div className="flex-1 flex items-center justify-center relative z-10 px-6 py-8">
          ...
          >
            ...
            <div className="mb-8">
              ...
              <h2 className="text-[1.75rem] font-bold tracking-tight text-zinc-900 dark:text-white mb-2">
                Welcome back
              </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {/* General Error */}
              {errors.general && (
                <div className="flex items-start gap-3 p-4 text-sm text-red-600 bg-red-50 border border-red-100 rounded-2xl dark:bg-red-950/40 dark:border-red-900/50 dark:text-red-400 animate-scale-in">
              ...
              <div className="space-y-2.5">
                ...
                <div className="relative">
                  <Input
                    ...
                    className={`h-13 pl-12 rounded-2xl bg-white dark:bg-white/[0.04] border-slate-200 dark:border-white/[0.08] text-[15px] focus-visible:border-blue-400 dark:focus-visible:border-blue-500/50 focus-visible:ring-blue-400/20 dark:focus-visible:ring-blue-500/20 shadow-sm transition-all duration-200 ${
                      errors.email
                ...
                {errors.email && (
                  <p className="text-xs text-red-500 flex items-center gap-1.5 animate-fade-in-up">
                    <AlertCircle size={12} />
                    {errors.email}
                  </p>
                )}
              ...
              <div className="space-y-2.5">
                ...
                <div className="relative">
                  <Input
                    ...
                    className={`h-13 pl-12 pr-13 rounded-2xl bg-white dark:bg-white/[0.04] border-slate-200 dark:border-white/[0.08] text-[15px] focus-visible:border-blue-400 dark:focus-visible:border-blue-500/50 focus-visible:ring-blue-400/20 dark:focus-visible:ring-blue-500/20 shadow-sm transition-all duration-200 ${
                      errors.password
                        ? "border-red-400 focus-visible:border-red-400 focus-visible:ring-red-400/20"
                        : ""
                    }`}
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300 transition-colors p-1.5 rounded-xl hover:bg-zinc-100 dark:hover:bg-white/[0.06]"
                    tabIndex={-1}
                    aria-label={
        ...
        {/* Bottom bar */}
        <div
          className={`relative z-10 flex items-center justify-between px-8 lg:px-12 py-5 border-t border-slate-200/60 dark:border-white/[0.06] transition-all duration-700 delay-500 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
        >
